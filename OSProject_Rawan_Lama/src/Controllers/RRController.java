...
import static Algorithms.RR.processListRR;
...
public class RRController implements Initializable {
    ...
    public void initialize(URL url, ResourceBundle rb) {
        // TODO
        showTable(processListRR);
        calculateAverages(processListRR);
...
//            if(i!=temp.size()-2 && temp.get(i).getId()==temp.get(i+1).getId()) {
//                temp.get(i).setEnd(temp.get(i+1).getEnd());
//                flag2=true;
//            }
