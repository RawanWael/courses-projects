...
import static Algorithms.EPWithPreemption.processListEPWithPreemption;
...
import static Algorithms.EPWithPreemption.ganttChatList;

public class EPWithPreemptionController implements Initializable {
    private ObservableList<Process> dataList;

    @FXML
    private TableView<Process> tvEPWithPreemption;
    ...
    public void initialize(URL url, ResourceBundle rb) {
        // TODO
        showTable(processListEPWithPreemption);
        calculateAverages(processListEPWithPreemption);
    ...
    public void showTable(ArrayList temp) {
        ...
        tvEPWithPreemption.setItems(dataList);
    }
